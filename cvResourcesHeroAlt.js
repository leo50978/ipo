export default class CvResourcesHeroAltComponent {
  constructor(rootId) {
    this.root = document.getElementById(rootId);

    if (!this.root) {
      console.error(`CV Resources Hero Alt root introuvable: ${rootId}`);
      return;
    }
...
const AUTO_ROOT_ID = "sierra-cv-resources-hero-alt-root";
if (document.getElementById(AUTO_ROOT_ID)) {
  new CvResourcesHeroAltComponent(AUTO_ROOT_ID);
}
